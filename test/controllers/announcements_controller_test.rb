...
class AnnouncementsControllerTest < ActionController::TestCase
  ...
  test "should create announcement" do
    assert_difference('Announcement.count') do
      post :create, announcement: { announcement_at: @announcement.announcement_at, exec_id: @announcement.exec_id, message: @announcement.message }
    end
  ...
  test "should update announcement" do
    patch :update, id: @announcement, announcement: { announcement_at: @announcement.announcement_at, exec_id: @announcement.exec_id, message: @announcement.message }
    assert_redirected_to announcement_path(assigns(:announcement))
  end
