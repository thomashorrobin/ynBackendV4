...
class IndividualsControllerTest < ActionController::TestCase
  ...
  test "should create individual" do
    assert_difference('Individual.count') do
      post :create, individual: { bio: @individual.bio, first_name: @individual.first_name, last_name: @individual.last_name }
    end
  ...
  test "should update individual" do
    patch :update, id: @individual, individual: { bio: @individual.bio, first_name: @individual.first_name, last_name: @individual.last_name }
    assert_redirected_to individual_path(assigns(:individual))
  end
